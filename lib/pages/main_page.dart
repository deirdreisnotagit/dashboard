    ...
    return Scaffold
      (
        appBar: AppBar
          ...
          title: Text('VA HD 2', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 30.0)),
          actions: <Widget>
          [
            Container
              (
              ...
              child: Row
                ...
                children: <Widget>
                [
                  Text('www.jennifercarrollfoy.org/', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
                ],
              ),
            )
          ],
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Voting Patterns', style: TextStyle(color: Colors.blueAccent)),
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Text('Jennifer Foy', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 22.0)),
                      Text('Delegate', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
            ),
